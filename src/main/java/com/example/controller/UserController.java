...
public class UserController {
    ...
    @GetMapping("/profile") // ユーザープロフィール表示
    ...
    @GetMapping("/profile/edit") // ユーザープロフィール編集フォーム表示
    ...
    @PostMapping("/profile/edit") // ユーザープロフィール更新
    public String updateProfile(@AuthenticationPrincipal UserDetails userDetails,
        ...
        User currentUser = userRepository.findByEmail(userDetails.getUsername()).get(); // 現在のユーザー情報を取得
